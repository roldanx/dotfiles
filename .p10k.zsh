# Generated by Powerlevel10k configuration wizard on 2021-05-29 at 17:36 CEST.
...
# blurred tails, 1 line, sparse, concise, transient_prompt, instant_prompt=verbose.
...
() {
  ...
  # ESTE PARÁMETRO ELIGE CUANTOS DIRECTORIOS NO SE ACORTAN A PARTIR DEL $PWD HACIA ATRÁS. 
  ...
  # NEXT LINE WAS COMMENTED BY ROLDANX:
